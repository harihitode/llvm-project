//===-- RISCIVTargetObjectFile.cpp - RISCIV Object Info -------------------===//
//
...
void RISCIVELFTargetObjectFile::Initialize(MCContext &Ctx,
...
bool RISCIVELFTargetObjectFile::isInSmallSection(uint64_t Size) const {
...
// section.
bool RISCIVELFTargetObjectFile::isGlobalInSmallSection(
...
MCSection *RISCIVELFTargetObjectFile::SelectSectionForGlobal(
...
void RISCIVELFTargetObjectFile::getModuleMetadata(Module &M) {
...
bool RISCIVELFTargetObjectFile::isConstantInSmallSection(
    const DataLayout &DL, const Constant *CN) const {
  return isInSmallSection(DL.getTypeAllocSize(CN->getType()));
}

MCSection *RISCIVELFTargetObjectFile::getSectionForConstant(
