//===-- RISCIVELFStreamer.h - ELF Target Streamer --------------*- C++ -*--===//
//
...
#ifndef LLVM_LIB_TARGET_RISCIV_RISCIVELFSTREAMER_H
#define LLVM_LIB_TARGET_RISCIV_RISCIVELFSTREAMER_H
...
class RISCIVTargetELFStreamer : public RISCIVTargetStreamer {
private:
...
public:
  ...
  RISCIVTargetELFStreamer(MCStreamer &S, const MCSubtargetInfo &STI);
