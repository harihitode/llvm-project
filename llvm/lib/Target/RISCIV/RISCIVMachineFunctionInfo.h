//=- RISCIVMachineFunctionInfo.h - machine function info ----------*- C++ -*-=//
//
...
//===----------------------------------------------------------------------===//
//
// This file declares RISCIV-specific per-machine-function information.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_RISCIV_RISCIVMACHINEFUNCTIONINFO_H
#define LLVM_LIB_TARGET_RISCIV_RISCIVMACHINEFUNCTIONINFO_H
...
/// RISCIVMachineFunctionInfo - This class is derived from MachineFunctionInfo
/// and contains private RISCIV-specific information for each MachineFunction.
class RISCIVMachineFunctionInfo : public MachineFunctionInfo {
private:
...
public:
  RISCIVMachineFunctionInfo(const MachineFunction &MF) {}
  ...
  bool useSaveRestoreLibCalls(const MachineFunction &MF) const {
    ...
    return MF.getSubtarget<RISCIVSubtarget>().enableSaveRestore() &&
...
#endif // LLVM_LIB_TARGET_RISCIV_RISCIVMACHINEFUNCTIONINFO_H
