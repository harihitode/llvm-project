//===-- RISCIVInstrInfo.h - Instruction Information -------------*- C++ -*-===//
//
...
#ifndef LLVM_LIB_TARGET_RISCIV_RISCIVINSTRINFO_H
#define LLVM_LIB_TARGET_RISCIV_RISCIVINSTRINFO_H
...
class RISCIVInstrInfo : public RISCIVGenInstrInfo {

public:
  explicit RISCIVInstrInfo(RISCIVSubtarget &STI);
